            ...
            <div class="lembrancinhas-content">
                <div class="lembrancinhas-text">
                    ...
                    <div class="lembrancinhas-cta">
                        <a href="<?php echo esc_url(get_term_link('lembrancinhas', 'product_cat')); ?>" class="btn btn--primary">
                            <?php esc_html_e('Comprar no Site', 'tema_aromas'); ?>
                        </a>
                        <a href="<?php echo esc_url('https://wa.me/5516991626921?text=' . rawurlencode('Olá! Gostaria de encomendar lembrancinhas personalizadas acima de 100 unidades.')); ?>" class="btn btn--whatsapp" target="_blank" rel="noopener noreferrer">
                            ...
                            <?php esc_html_e('WhatsApp +100 un.', 'tema_aromas'); ?>
                        </a>
                    </div>
                </div>
