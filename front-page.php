        ...
        <section class="lembrancinhas-block">
            <div class="lembrancinhas-content">
                <div class="lembrancinhas-text">
                    ...
                    <p class="section-subtitle">
                        <?php esc_html_e('Torne seu evento ainda mais especial com nossas lembrancinhas personalizadas. Mini Velas Aromáticas ou Mini Home Sprays com fragrâncias exclusivas para encantar seus convidados.', 'tema_aromas'); ?>
                    </p>

                    <div class="lembrancinhas-options">
                        <div class="lembrancinhas-option">
                            ...
                            <span><?php esc_html_e('Compre de 25, 50 ou 100 unidades direto no site', 'tema_aromas'); ?></span>
                        </div>
                        <div class="lembrancinhas-option">
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true">
                                <path d="M12 2L15.09 8.26L22 9.27L17 14.14L18.18 21.02L12 17.77L5.82 21.02L7 14.14L2 9.27L8.91 8.26L12 2Z"></path>
                            </svg>
                            <span><?php esc_html_e('Escolha entre 4 fragrâncias exclusivas por tipo', 'tema_aromas'); ?></span>
                        </div>
                        <div class="lembrancinhas-option">
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true">
                                <path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"></path>
                            </svg>
                            <span><?php esc_html_e('Acima de 100 unidades? Fale conosco pelo WhatsApp', 'tema_aromas'); ?></span>
                        </div>
                    </div>

                    <div class="lembrancinhas-cta">
                        <a href="<?php echo esc_url(get_term_link('lembrancinhas', 'product_cat')); ?>" class="btn-luxury">
                            <?php esc_html_e('Comprar Lembrancinhas', 'tema_aromas'); ?>
                        </a>
                        <a href="<?php echo esc_url('https://wa.me/5516991626921?text=' . rawurlencode('Olá! Gostaria de encomendar lembrancinhas personalizadas acima de 100 unidades.')); ?>" class="btn-luxury-outline" target="_blank" rel="noopener noreferrer">
                            ...
                            <?php esc_html_e('WhatsApp para +100 un.', 'tema_aromas'); ?>
                        </a>
                    </div>
                </div>
