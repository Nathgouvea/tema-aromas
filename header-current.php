                    ...
                    <?php else : ?>
                        ...
                        <div class="primary-menu-container">
                            <ul id="primary-menu" class="primary-menu luxury-menu">
                                ...
                                <li class="menu-item">
                                    <a href="<?php echo esc_url(get_permalink(get_page_by_path('sobre-os-aromas'))); ?>" class="menu-link">
                                        <?php esc_html_e('SOBRE OS AROMAS', 'tema_aromas'); ?>
                                    </a>
                                </li>
                                <li class="menu-item">
                                    <a href="<?php echo esc_url(get_permalink(get_page_by_path('fale-conosco'))); ?>" class="menu-link">
